      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="f-col">
            <h4 className="f-col-title">Company</h4>
            <ul className="f-links">
              <li><Link to="/?scroll=home">Home</Link></li>
          ...
          <div className="f-col f-services">
            ...
            <div className="f-services-grid">
              ...
              <li><Link to="/services?scroll=bpm">BPM & Workflow</Link></li>
              <li><Link to="/services?scroll=digital">Digital Transformation</Link></li>
              <li><Link to="/services?scroll=cloud">Cloud & Data Engineering</Link></li>
              <li><Link to="/services?scroll=product">Product Engineering</Link></li>
              </ul>
            </div>
          </div>
          ...
          {/* Upcoming services */}
          <div className="f-col f-services">
            <h4 className="f-col-title">Upcoming Services</h4>
            <div className="f-services-grid">
              <ul className="f-links">
                <li><Link to="/services?scroll=bms">Building Management (BMS)</Link></li>
                <li><Link to="/services?scroll=fms">Facility Management (FMS)</Link></li>
                <li><Link to="/services?scroll=fdd">Fault Detection (FDD)</Link></li>
                <li><Link to="/services?scroll=cda">Data & Analytics (CDA)</Link></li>
              </ul>
            </div>
          </div>
          ...
          <div className="f-col f-contact">
            ...
            <div className="contact-item">
              ...
              <a href='https://maps.app.goo.gl/qiWc65YxaP9HAqEc9'>30/70, Vivekanand House, Padma Nagar, Akkalkot Road, Solapur - 413005</a>
            </div>
